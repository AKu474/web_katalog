...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cek_pengguna = "select * from pengguna where email='" . $email . "' and password='" . $password . "' limit 1";
    ...
    if ($jumlah > 0) {
        ...
        $pesan = "<div class='alert alert-danger'><strong>Error!</strong> email dan password salah.</div>";
    }
}
?>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <?php if (isset($_GET['pesan'])) {
            if ($_GET["pesan"] == "login_dulu") echo "<div class='alert alert-danger'>Anda harus login dulu</div>";
        } ?>
        <div class="row">
